(function() {
  ...
  global.jasmine.addExecutionFilter(function(specsToRun) {
    if (!focusedRunnables.length) {
      return specsToRun;
    }

    return jasmine.executionFiltersUtil.filterRunnablesFromCurrentRunnables(focusedRunnables, specsToRun);
  });
})();
